...
if choice1 == 'yard':
    print(f"""you see that there is a Action Comics #27 in pristine condition, however you already have that comic from your late father, who was a comic writer. and you do not see {comic_holy_grail_1}.""")
elif choice1 == 'estate':
...
choice3 = input("""as you walk away from the comic shop you bump in to someone. as you walk away you notice that you are missin your copy of Action Comics #27. Do you chase after the person you bumped into? 'yes' or  'no'?""")
...
if choice4 == 'pummel':
    print(f"""you punch Bob The Comic Baron with all your might but break your hand and deal{pummel_damage}. then bob attacks dealing 1 damage. you have failed. GAME OVER : YOU LOST YOUR OTHER HOLY GRAIL: Action Comics #27""")
    exit()
elif choice4 == 'magic':
